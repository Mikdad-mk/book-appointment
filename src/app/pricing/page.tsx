    ...
    <div>
      ...
      <section className="relative py-12 lg:py-24 overflow-hidden">
        <Image
          ...
          src="/fauna-assets/pricing/waves-right-top.png"
          alt=""
          width={400}
          height={300}
        />
          ...
          <div className="flex flex-wrap -mx-4 mb-24">
            <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
              <div className="relative pt-14 pb-8 px-8 bg-orange-50 rounded-2xl overflow-hidden">
                ...
                <Link
                  className="inline-flex w-full group py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200"
                  href="#!"
                >
            ...
            <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
              <div className="relative pt-14 pb-8 px-8 bg-lime-500 rounded-2xl overflow-hidden">
                ...
                <p className="text-lg mb-8">For medium households or businesses with higher energy consumption</p>
                <Link
                  className="inline-flex w-full group py-4 px-6 items-center justify-center text-lg font-medium text-black hover:text-white border border-teal-900 hover:bg-teal-900 rounded-full transition duration-200"
                  href="#!"
                >
